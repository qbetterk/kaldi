...
if [ $stage -le 1 ];then
    for name in sre train callhome1_0 callhome2_0; do
...
if [ $stage -le 11 ];then
    ...
    # OVERALL SPEAKER DIARIZATION ERROR = 17.29 percent of scored speaker time  `(ALL)
...
if [ $stage -le 12 ];then
    ...
    # OVERALL SPEAKER DIARIZATION ERROR = 16.53 percent of scored speaker time  `(ALL)
